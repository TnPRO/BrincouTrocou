 ...
 facebookConnectPlugin.login(["email"], function(response) 
	...
	alert("Erro na autenticação com Facebook");
		...
		facebookConnectPlugin.api( "me/?fields=id,email,name", ["email"],
                    ...
                    function (response) { facecheck(JSON.stringify(response.email),JSON.stringify(response.id),JSON.stringify(response.name)) },

                    function (response) { alert(JSON.stringify(response)) });
        } 


function facecheck(mail,id,name){



ur = "http://www.brincoutrocou.com.br/check_user.asp?face=T&email=" + mail + "&senha=" + id + "&nome=" + name + "&birth=";
