window.open    = function(){
   ...
   if (res) {
    ...
    function saldo(){
      ...
      ur = "http://www.brincoutrocou.com.br/saldo.asp?usuario="+ localStorage.brincoutrocou; 
    ...
    function compr(moedas){
      ...
      ur = "http://www.bolao14.com/app/comprarface.asp?usuario="+ localStorage.brincoutrocou + "&moedas=" + moedas; 
